...
function App() {
  ...
  return (
    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500'>
      ...
      <input type="text" value={password} className='outline-none w-80 py-1 px-3' placeholder='Password' readOnly/>
      <button ref={passwordRef} onClick={copyPasswordToClipboard} className='outline-none h-9 bg-blue-700 text-white px-3 py-0.5 shrink-0 '>copy</button>
      </div>
